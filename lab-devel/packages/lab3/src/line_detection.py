...
class ImageProcessor: 
    ...
    def white_filter(self):
        ...
        #mask = cv2.inRange(self.hsv_image, (30,0,129), (180,255,255)) #(70,0,145),(140,120,255)
        mask = cv2.inRange(self.hsv_image, (30,0,129), (180,255,255))
    ...
    def yellow_filter(self):
        ...
        mask = cv2.inRange(self.hsv_image, (18,80,80), (35,255,255))
        kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (3,3))
        kernel2 = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (5,5))
        # image_erode = cv2.erode(red_part, kernel)
        image_erode = cv2.erode(mask, kernel)
